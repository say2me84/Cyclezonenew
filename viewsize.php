<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_size` WHERE `SizeID` = '".$_REQUEST['id']."'";
        ...
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_size` WHERE Active='1'";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['SizeName'];?></span></td>
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/size.php?action=edit&id=<?php echo $RsselectCustomer['SizeID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <!--<a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewsize.php?action=delete&id=<?php echo $RsselectCustomer['SizeID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/size.php?action=add" class="btn btn-default">Add Size</a>
            </div>
        </div>
   </div>
</section> 
