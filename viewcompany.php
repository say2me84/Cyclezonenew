<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_company` WHERE `CompanyID` = '".$_REQUEST['id']."'";
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Company</div>
            <?php
                if($Msg!="")
                {
                    ?>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_company` WHERE Active='1'";
                                        ...
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            ...
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/company.php?action=edit&id=<?php echo $RsselectCustomer['CompanyID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <!--<a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewcompany.php?action=delete&id=<?php echo $RsselectCustomer['CompanyID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/company.php?action=add" class="btn btn-default">Add Company</a>
            </div>
        </div>
   </div>
</section> 
