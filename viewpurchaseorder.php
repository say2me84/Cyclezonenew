<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_customer` WHERE `CustomerID` = '".$_REQUEST['id']."'";
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Customer</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered table-hover bg-white">
                    <tbody>
                        <tr style="font-weight: bold">
                            ...
                            <td style="width:20%">Billing City</td>
                            <td style="width:20%">Type</td>
                            <td style="width:25%">Edit</td>
                        </tr>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_customer`,master_type WHERE master_customer.Active='1' AND master_customer.TypeID=master_type.TypeID";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['FirstName']." ".$RsselectCustomer['LastName'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['MobileNumber'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['BillingCity'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['TypeName'];?></span></td>
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/customer.php?action=edit&id=<?php echo $RsselectCustomer['CustomerID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewcustomer.php?action=delete&id=<?php echo $RsselectCustomer['CustomerID'];?>">
                ...
                <a href="<?php echo PreURL;?>/customer.php?action=add" class="btn btn-default">Add Customer</a>
            </div>
        </div>
   </div>
</section> 
