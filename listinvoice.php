...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Retail Invoice</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <thead>                    
                        <tr style="font-weight: bold">
                            <th class="head0 text-center">ID</th>
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_invoice`,master_customer WHERE master_invoice.Type='customer' AND master_invoice.CustomerID = master_customer.CustomerID Order by InvoiceID Desc";
                            //echo $selectCustomer;
                                ...
                                {    
                                    ...
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td class="text-center"><?php echo intval($RsselectCustomer['InvoiceNo']);?></td>
                                            ...
                                            <td style="white-space: nowrap" class="text-center">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="<?php echo PreURL;?>/viewinvoice.php?id=<?php echo $RsselectCustomer['InvoiceID'];?>">
                                                        <em class="fa fa-eye"></em>
                                                    </a>
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/invoice.php?action=edit&id=<?php echo $RsselectCustomer['InvoiceID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/listinvoice.php?action=delete&id=<?php echo $RsselectCustomer['InvoiceID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/invoice.php?action=add" class="btn btn-default">Add Invoice</a>
            </div>
        </div>
   </div>
</section> 
