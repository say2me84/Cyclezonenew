<?php
    $title = "View Cycle Product";
    include("config.php");
    $Msg = "";
    
    if($_REQUEST['action']=="delete" && $_REQUEST['id']!="")
    {
        $DeleteProduct = "DELETE FROM `master_products` WHERE `ProductID` = '".$_REQUEST['id']."'";
        mysqli_query($DeleteProduct);
    }    
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Cycle Product</div>
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_products`,master_company WHERE master_company.CompanyID = master_products.CompanyID AND master_products.Active='1'";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['ProductID'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['CompanyName'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['Segment'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['ModalName'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['Color'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['Size'];?></span></td>
                                            
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/product.php?action=edit&id=<?php echo $RsselectCustomer['ProductID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <!--<a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewproduct.php?action=delete&id=<?php echo $RsselectCustomer['ProductID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/product.php?action=add" class="btn btn-default">Add Product</a>
            </div>
        </div>
   </div>
</section> 
