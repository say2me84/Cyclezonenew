...
<style>
    ...
    .table > tbody > tr > td, .table > tbody > tr > th, .table > tfoot > tr > td, .table > tfoot > tr > th, .table > thead > tr > td, .table > thead > tr > th{padding:2px 5px;font-size:11px;}
    .table > thead > tr > th {color: #fff !important;padding-bottom: 5px !important;padding-top: 5px !important;}
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-left">
                                                            ...
                                                            <?php
                                                                if($RsselectRow['Type']=="cycle")
                                                                {
                                                                    $selectCyclePrice = "SELECT * from master_inventory_child,master_cyclezone_price WHERE master_cyclezone_price.InventoryChildID = master_inventory_child.InventoryChildID AND Type = 'cycle' AND Size = '".mysqli_real_escape_string($conn, $RsselectRow['Size'])."' AND Color='".$RsselectRow['Color']."' AND ModalName = '".$RsselectRow['ModelNumber']."' AND CompanyName = '".$RsselectRow['CompanyID']."' AND master_inventory_child.Active='1'";        
...
//                                                                }
                                                                ...
                                                                //echo $FinalTotalTaxValue;
                                                                echo number_format($RsselectRow['Price']-floatval($FinalTotalTaxValue),2,".",",");
                                                        ...
                                                        <td class="text-right"><?php echo number_format(floatval($RsselectRow['Price']-floatval($FinalTotalTaxValue)) * floatval($RsselectRow['Quantity']),2,".",",");?></td>
                                                    </tr>
                                                <?php
                                            }
                    ...
                    <div class="panel-body">
                            <div class="row-fluid noprint"> 
                                <div class="span12">        
                                    ...
                                    <div>
                                        <button id="PrintInvoice" type="button" class="mr btn btn-labeled btn-success text-center" tabindex="18">
                                            <span class="btn-label">
                                                <i class="fa fa-print"></i>
                                            </span>Print
                                        </button>
                                        <button id="BtnInvoiceEmail" type="button" class="mr btn btn-labeled btn-success text-center" tabindex="18">
                                            <span class="btn-label">
...
<script type="text/javascript">
    $(document).ready(function() {
        $("#BtnInvoiceEmail").click(function() {
            var thisobj = $(this);
            thisobj.html('<span class="btn-label"><i class="fa fa-envelope"></i></span>Please Wait...');
            $.ajax({
                url: 'ajax.php?filter=SendRetailEmailInvoice&InvoiceID=<?php echo $_REQUEST['id'];?>',
                success: function(html) 
                {
                    if(html=="1")
                    {
                        thisobj.html('<span class="btn-label"><i class="fa fa-envelope"></i></span>Email Sent');
                    }
                    else
                    {
                        thisobj.html('<span class="btn-label"><i class="fa fa-envelope"></i></span>Email not Sent');
                    }
