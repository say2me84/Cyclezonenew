<?php
    ...
    $selectCustomer = "SELECT * FROM `master_merchant` WHERE master_merchant.MerchantID='".$RsselectInvoive['CustomerID']."'";
            ...
            <div class="mainbar">
                <div class="panel panel-default MainPrintInvoiceBox" style="padding:10px;">
                    ...
                    <div style="float:left;padding:10px;width:60%;">
                        ...
                        ?>
                        <?php
                            if($RsselectCustomer['MerchantID']!="")
                            {
                                ?>
                                    <div style="font-weight:normal;">
                                        <div style="float:left;width:150px;font-size: 14px;"><b>Merchant ID</b></div>
                                        <div style="float:left;width:150px;font-size: 14px;"><?php echo $RsselectCustomer['MerchantID'];?></div>
                                        <div style="clear:both;"></div>
                                    </div>
                                <?php
                            }
                    ...
                    <div style="float:right;width:40%;font-weight:normal;">
                        <div style="text-align:right;">
                            <div style="padding:10px;">
                                <div>
                                    <div style="float:right;width:120px;text-align:left;font-size: 14px;"><b>Merchant Invoice</b></div>
                                ...
                                <div style="margin-bottom:10px;border-bottom:1px solid #000;float:right;">
                                    <div style="float:right;width:120px;text-align:left;font-size: 14px;"><b>MRTIN<?php echo sprintf("%04d", $RsselectInvoive['InvoiceNo']);?><b></div>
                                ...
                                <div>
                                    <?php 
                                        if($RsselectInvoive['IsTinNumber']=="1")
                                        {
                                            $TinNumber = $RsselectCustomer['TinNumber'];    
                                        }
                                        else
                                        {
                                            $TinNumber = "Not Mension";
                                        }
                                    ?>
                                    <div style="float:right;width:120px;text-align:left;font-size: 14px;font-weight:normal;"><?php echo $TinNumber;?></div>
                                    <div style="float:right;width:120px;text-align: left;font-size: 14px;"><b>TIN Number</b></div>
                                    <div style="clear:both;"></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <table class="table table-bordered table-hover bg-white">
                                    ...
                                    <tbody>
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    <td colspan="7" class="text-right" style="color:#000;">Sub Total</td>
                                                    <td class="text-right">
                                                        <?php 
                                            ...
                                            foreach($TaxApplied as $k=>$v)
                                            {
                                                ...
                                                ?>
                                                    <tr>
                                                        <td colspan="7" class="text-right" style="color:#000;"><?php echo $RsselectTax['TaxName']." (".$RsselectTax['TaxPer']."%)"?></td>
                                                        <td class="text-right">
                                                            <?php 
                                        ...
                                        <tr>
                                            <td colspan="7" class="text-right" style="color:#000;">Shipping Charge</td>
                                        ...
                                        <tr>
                                            <td colspan="7" class="text-right" style="color:#000;">Discount</td>
                                        ...
                                        <tr class="active">
                                            <td colspan="7" class="text-right" style="color:#000;">Total Price</td>
