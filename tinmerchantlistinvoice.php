<?php
    $title = "View Tin Mechant Invoice";
    include("config.php");
    $Msg = "";
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Tin Mechant Invoice</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_invoice`,master_merchant WHERE `master_invoice`.Type='tinmerchant' AND master_invoice.CustomerID = master_merchant.MerchantID Order by InvoiceID Desc";
                                ...
                                {    
                                    ...
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td class="text-center"><span><a href="tinmerchantviewinvoice.php?id=<?php echo $RsselectCustomer['InvoiceID'];?>">MRTIN<?php echo sprintf("%04d", $RsselectCustomer['InvoiceNo']);?></a></span></td>
                                            ...
                                            <td style="white-space: nowrap" class="text-center">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="<?php echo PreURL;?>/tinmerchantviewinvoice.php?id=<?php echo $RsselectCustomer['InvoiceID'];?>">
                                                        <em class="fa fa-eye"></em>
                                                    </a>
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/tinmerchantinvoice.php?action=edit&id=<?php echo $RsselectCustomer['InvoiceID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/tinmerchantlistinvoice.php?action=delete&id=<?php echo $RsselectCustomer['InvoiceID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/tinmerchantinvoice.php?action=add" class="btn btn-default">Add Invoice</a>
            </div>
        </div>
   </div>
</section> 
