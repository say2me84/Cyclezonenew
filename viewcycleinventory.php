...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Cycle Zone Price</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * from master_inventory_child,master_company WHERE master_inventory_child.Parents='0' AND master_inventory_child.CompanyName = master_company.CompanyID Order By master_inventory_child.InventoryChildID DESC";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><?php echo $RsselectCustomer['InventoryChildID'];?></td>
                                            <td><?php echo $RsselectCustomer['Type'];?></td>
                                            <td><?php echo $RsselectCustomer['CompanyName'];?></td>
                                            <td>
                                                <?php 
                                                    if($RsselectCustomer['Type']=="cycle")
                                                    {
                                                        echo $RsselectCustomer['ModalName'];    
                                                    }
                                                    else
                                                    {
                                                        echo $RsselectCustomer['ItemName'];                                                            
                                                    }
                                                ?>
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-right">
                                                <?php 
                                                    $selectCycle = "SELECT * from master_cyclezone_price WHERE InventoryChildID = '".$RsselectCustomer['InventoryChildID']."'";
                                                    $ObjselectCycle = mysqli_query($selectCycle);
                                                    $NumselectCycle = mysqli_num_rows($ObjselectCycle);
                                                    if($NumselectCycle>0)
                                                    {
                                                        $RsselectCycle = mysqli_fetch_array($ObjselectCycle);
                                                        $Price = $RsselectCycle['CycleTotalPrice'];
                                                    }   
                                                    else
                                                    {
                                                        $Price = 0;                                                       
                                            ...
                                            <td class="text-center" style="white-space: nowrap">
                                                ...
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm <?php echo $Class;?>" href="<?php echo PreURL;?>/cycleinventory.php?action=edit&id=<?php echo $RsselectCustomer['InventoryChildID'];?>">
