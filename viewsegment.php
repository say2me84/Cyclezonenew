<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_segment` WHERE `SegmentID` = '".$_REQUEST['id']."'";
        ...
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_segment` WHERE Active='1'";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['SegmentName'];?></span></td>
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/segment.php?action=edit&id=<?php echo $RsselectCustomer['SegmentID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <!--<a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewsegment.php?action=delete&id=<?php echo $RsselectCustomer['SegmentID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/segment.php?action=add" class="btn btn-default">Add Segment</a>
            </div>
        </div>
   </div>
</section> 
