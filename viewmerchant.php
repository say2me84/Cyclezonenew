<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_merchant` WHERE `MerchantID` = '".$_REQUEST['id']."'";
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Merchant</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_merchant`";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['MerchantID'];?></span></td>
                                            ...
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/merchant.php?action=edit&id=<?php echo $RsselectCustomer['MerchantID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <!--<a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewmerchant.php?action=delete&id=<?php echo $RsselectCustomer['MerchantID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/merchant.php?action=add" class="btn btn-default">Add Merchant</a>
            </div>
        </div>
   </div>
</section> 
