<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_user` WHERE `UserID` = '".$_REQUEST['id']."'";
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Users</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    ...
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_user`";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['UserID'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['FirstName']." ".$RsselectCustomer['LastName'];?></span></td>
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/user.php?action=edit&id=<?php echo $RsselectCustomer['UserID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewuser.php?action=delete&id=<?php echo $RsselectCustomer['UserID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/user.php?action=add" class="btn btn-default">Add User</a>
            </div>
        </div>
   </div>
</section> 
