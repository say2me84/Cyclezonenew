<?php
    ...
    {
        $DeleteCustomer = "DELETE FROM `master_tax` WHERE `TaxID` = '".$_REQUEST['id']."'";
...
<section class="ng-scope">
    <div ui-view="" autoscroll="false" ng-class="app.views.animation" class="app ng-scope ng-fadeInLeft2">
        <div ui-view="" ng-class="app.views.animation" class="ng-scope ng-fadeInLeft2">
            <div class="app-view-header ng-scope">View Tax</div>
            ...
            <div ng-controller="TablexEditableController as xtable" class="container-fluid ng-scope">
                <table class="table table-bordered" id="example" >
                    <thead>
                        <tr style="font-weight: bold">
                            ...
                            <th style="width:20%">Tax Percentage</th>
                            <th style="width:25%">Edit</th>
                        </tr>
                    </thead>
                    <tbody>
                        <?php
                            $selectCustomer = "SELECT * FROM `master_tax` WHERE master_tax.Active='1'";
                                ...
                                {        
                                    ?>
                                        <tr ng-repeat="user in xtable.users" class="ng-scope">
                                            <td><span><?php echo $RsselectCustomer['TaxName'];?></span></td>
                                            <td><span><?php echo $RsselectCustomer['TaxPer'];?></span></td>
                                            <td style="white-space: nowrap">
                                                <div ng-show="!rowform.$visible" class="buttons">
                                                    <a class="btn btn-sm btn-info" href="<?php echo PreURL;?>/tax.php?action=edit&id=<?php echo $RsselectCustomer['TaxID'];?>">
                                                        <em class="fa fa-pencil"></em>
                                                    </a>
                                                    <!--<a class="btn btn-sm btn-danger" href="<?php echo PreURL;?>/viewtax.php?action=delete&id=<?php echo $RsselectCustomer['TaxID'];?>">
                ...
                <div>&nbsp;</div>
                <a href="<?php echo PreURL;?>/tax.php?action=add" class="btn btn-default">Add Tax</a>
            </div>
        </div>
   </div>
</section> 
