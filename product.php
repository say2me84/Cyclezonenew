<?php
    ...
    if($_POST)
    {
        ...
        if($_REQUEST['action']=="add")
        {
            $selectProduct = "SELECT * FROM `master_products` WHERE CompanyID='".$_POST['CompanyID']."' AND ModalName='".$_POST['ModalName']."' AND Color='".$_POST['Color']."' AND Size='".mysqli_real_escape_string($_POST['Size'])."'";
            $ObjselectProduct = mysqli_query($selectProduct);
            $NumselectProduct = mysqli_num_rows($ObjselectProduct);
            if($NumselectProduct==0)
            {
                $InsertProduct = "INSERT INTO `master_products` (
                                                                `CompanyID` ,
                                                                `Segment` ,
                                                                `ModalName` ,
                                                                `Color` ,
        ...
        {
            $selectProduct = "SELECT * FROM `master_products` WHERE CompanyID='".$_POST['CompanyID']."' AND ModalName='".$_POST['ModalName']."' AND Color='".$_POST['Color']."' AND Size='".mysqli_real_escape_string($_POST['Size'])."' AND ProductID <> '".$_REQUEST['id']."'";
            $ObjselectProduct = mysqli_query($selectProduct);
            $NumselectProduct = mysqli_num_rows($ObjselectProduct);
            if($NumselectProduct==0)
            {
                $UpdateProduct = "UPDATE `master_products` SET  `CompanyID` = '".$_POST['CompanyID']."',
                                                                `Segment` = '".$_POST['Segment']."',
                                                                `ModalName` = '".$_POST['ModalName']."',
                                                                `Color` = '".$_POST['Color']."',
                                                                `Size` = '".$_POST['Size']."'
                                                                 WHERE `ProductID` ='".$_REQUEST['id']."';";
    ...
    {
        $title = "Edit Product";    
        $selectProduct = "SELECT * FROM `master_products` WHERE ProductID='".$_REQUEST['id']."'";
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form action="" method="post">
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <label for="input-id-1" class="col-sm-2 control-label">Segment</label>
                                    <div class="col-sm-10">
                                        <select class="form-control shadow-z1" id="Segment" name="Segment">
                                            <option value="">Select Segment</option>
                                            <?php
                                                $selectCompany= "SELECT * FROM `master_segment` WHERE Active='1'";
                                                $ObjselectCompany = mysqli_query($selectCompany);
                                                while($RsselectCompany = mysqli_fetch_array($ObjselectCompany))
                                                {
                                                    if(trim($RsselectCustomer['Segment'])==$RsselectCompany['SegmentName'])
                                                    {
                                                        $Selected = 'selected="selected"';
                                                    }
                                                    else
                                                    ...
                                                    ?>
                                                        <option <?php echo $Selected;?> value="<?php echo $RsselectCompany['SegmentName'];?>"><?php echo $RsselectCompany['SegmentName'];?></option>
                                                    <?php        
                                                }
                                            ?>                                            
                                        </select>
                                        <!--<input value="<?php echo $RsselectCustomer[''];?>" id="Segment" name="Segment" placeholder="Segment" type="text" class="form-control shadow-z1">-->
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control shadow-z1" id="ModalName" name="ModalName">
                                            <option value="">Select Modal Name</option>
                                            <?php
                                                $selectCompany= "SELECT * FROM `master_modal_name` WHERE Active='1'";
                                                $ObjselectCompany = mysqli_query($selectCompany);
                                                while($RsselectCompany = mysqli_fetch_array($ObjselectCompany))
                                                {
                                                    if($RsselectCustomer['ModalName']==$RsselectCompany['ModalName'])
                                                    {
                                                        $Selected = 'selected="selected"';
                                                    }
                                                    else
                                                    ...
                                                    ?>
                                                        <option <?php echo $Selected;?> value="<?php echo $RsselectCompany['ModalName'];?>"><?php echo $RsselectCompany['ModalName'];?></option>
                                                    <?php        
                                                }
                                            ?>                                            
                                        </select>
                            ...
                            <fieldset>
                                <div class="form-group">
                                    <label for="input-id-1" class="col-sm-2 control-label">Color</label>
                                    <div class="col-sm-10">
                                        <select class="form-control shadow-z1" id="Color" name="Color">
                                            <option value="">select Color</option>
                                            <?php
                                                $selectCompany= "SELECT * FROM `master_color` WHERE Active='1'";
                                                $ObjselectCompany = mysqli_query($selectCompany);
                                                while($RsselectCompany = mysqli_fetch_array($ObjselectCompany))
                                                {
                                                    if($RsselectCustomer['Color']==$RsselectCompany['ColorName'])
                                                    {
                                                        $Selected = 'selected="selected"';
                                                    }
                                                    else
                                                    ...
                                                    ?>
                                                        <option <?php echo $Selected;?> value="<?php echo $RsselectCompany['ColorName'];?>"><?php echo $RsselectCompany['ColorName'];?></option>
                                                    <?php        
                                                }
                                            ?>                                            
                                        </select>
                                        <!--<input value="<?php echo $RsselectCustomer['Color'];?>" id="Color" name="Color" placeholder="Color" type="text" class="form-control shadow-z1">-->
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
                                <div class="form-group">
                                    <label for="input-id-1" class="col-sm-2 control-label">Size</label>
                                    <div class="col-sm-10">
                                        <select class="form-control shadow-z1" id="Size" name="Size">
                                            <option value="">select Size</option>
                                            <?php
                                                $selectCompany= "SELECT * FROM `master_size` WHERE Active='1'";
                                                $ObjselectCompany = mysqli_query($selectCompany);
                                                while($RsselectCompany = mysqli_fetch_array($ObjselectCompany))
                                                {
                                                    if($RsselectCustomer['Size']==$RsselectCompany['SizeName'])
                                                    {
                                                        $Selected = 'selected="selected"';
                                                    }
                                                    else
                                                    ...
                                                    ?>
                                                        <option <?php echo $Selected;?> value='<?php echo $RsselectCompany['SizeName'];?>'><?php echo $RsselectCompany['SizeName'];?></option>
                                                    <?php        
                                                }
                                            ?>                                            
                                        </select>
                                        <!--<input value="<?php echo $RsselectCustomer['Size'];?>" id="Size" name="Size" placeholder="Size" type="text" class="form-control shadow-z1">-->
                                    </div>
                                </div>
                            </fieldset>
                            <fieldset>
